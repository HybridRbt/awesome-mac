...
 现在这个库的规模已经大了很多，并且与最初的想法颇有不同。我们在此收集各种类别下的好用的 Mac 软件。欢迎加星收藏或者复刻。

有任何建议和评论，欢迎在阅读[参与讨论的基本共识](https://github.com/jaywcjlove/awesome-mac/blob/master/CONTRIBUTING.md)以后以[issue](https://github.com/jaywcjlove/awesome-mac/issues)的形式提出。文档格式参照 [awesome 列表](https://github.com/sindresorhus/awesome)。
...
* [Maccy](https://github.com/p0deje/Maccy) - 开源于Github但不免费的剪贴板管理工具, 应用商店中下载需要付费 [![Open-Source Software][OSS Icon]
...
* [NotePlan 3](https://noteplan.co/) - 您的任务、笔记和日历、纯文本 Markdown 文件。 [![App Store][app-store Icon]](https://apps.apple.com/en/app/noteplan-3/id1505432629)
